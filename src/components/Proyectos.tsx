  ...
  const projects = [
    {
      ...
      technologies: ["React Native", "Docker" , "JWT" , "Redux", "MQTT", "TypeScript", "JavaScript", "PostgreSQL", "Express", "Sequelize", "C++", "Docker", "CI/CD", "AWS"],
      imageUrl: p2,
    ...
    },
    {
      ...
      technologies: ["Angular", "Firebase", "HTML", "CSS", "TypeScript", "Bootstrap"],
      imageUrl: p3,
      githubUrls: [
